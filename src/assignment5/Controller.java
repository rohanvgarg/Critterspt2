...
public class Controller
{
    ...
    protected static Button makeButton1;
    protected static Button makeButton5;
    protected static Button makeButton10;
    protected static Button runStatsButton;
    protected static Button timeStepButton;
    protected static Button seedButton;
    protected static TextField seedField;
    protected static RadioButton rb1;
    protected static RadioButton rb5;
    protected static RadioButton rb20;
    ...
    protected static void setSeedPane(GridPane mainPane)
    {
        ...
        seedField = new TextField("Enter Seed");
    ...
    private static void animateButtonEventHandler(Button but)
    {
        ...
        if (View.anim == true)
        {
            ...
            makeButton1.setDisable(true);
            makeButton5.setDisable(true);
            ...
            critterSelectComboBox.setDisable(true);
        ...
        } else
        {
            ...
            critterSelectComboBox.setDisable(false);
